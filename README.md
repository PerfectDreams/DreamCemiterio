...
<h1 align="center">👻 DreamCemiterio 👻</h1>
<p align="center">
<a href="https://jenkins.perfectdreams.net/job/DreamCemiterio/"><img src="https://jenkins.perfectdreams.net/job/DreamCemiterio/badge/icon"></a>
<a href="https://github.com/PerfectDreams/DreamCemiterio/blob/master/LICENSE"><img src="https://img.shields.io/badge/license-AGPL%20v3-lightgray.svg"></a>
</p>
<p align="center">
<a href="https://github.com/PerfectDreams/DreamCemiterio/watchers"><img src="https://img.shields.io/github/watchers/PerfectDreams/DreamCemiterio.svg?style=social&label=Watch"></a>
<a href="https://github.com/PerfectDreams/DreamCemiterio/stargazers"><img src="https://img.shields.io/github/stars/PerfectDreams/DreamCemiterio.svg?style=social&label=Stars"></a>
</p>
...
* Eu não irei dar suporte caso você queria usar o nosso projeto no seu servidor sem dar nada em troca para o PerfectDreams, lembre-se, a licença do projeto é [AGPL v3](https://github.com/PerfectDreams/DreamCemiterio/blob/master/LICENSE), você é **obrigado a deixar todas as suas alterações no projeto públicas**!
...
7. Faça ```git clone https://github.com/PerfectDreams/DreamCemiterio.git``` em alguma pasta no seu computador.
...
Nós utilizamos várias [dependências no código-fonte](https://github.com/PerfectDreams/DreamCemiterio/blob/master/pom.xml) deste projeto, obrigado a todos os mantenedores das dependências! Sem vocês, talvez nosso projeto não iria existir (ou teria várias funcionalidades reduzidas ou talvez até inexistentes!)
